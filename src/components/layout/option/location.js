    ...
    return (
        <>
            <div className='container-fluid'>
                ...
                <div className="px-3">
                    <select id="locker-location" onChange={(e)=> setLocation(e.target.value)} className="fs-28 my-3 text-dark form-control form-select shadow-none text-center height-66 center">
