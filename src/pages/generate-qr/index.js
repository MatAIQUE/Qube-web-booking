            ...
            <div className='row'>
                    ...
                    <div className='row  p-lg-5 m-lg-auto'>
                        <div className='mx-auto col-xl-12 col-lg-12 col-md-12 col-sm-6 col-6'>
                            <div className='w-100'>
                                ...
                                <BannerText unboldChar="Your QR is ready!" boldChar={`Scan this to ${location}'s QUBE Smart Locker`}/>
                            </div>
                        </div>
                ...
                <div className='col-lg-6 right-panel mx-auto alert alert-success p-lg-5'>
                                ...
                                <div className='row'>
                                    <div className='col-6 text-left'>
                                        <div px-5 py-3>
                                            ...
                                            <div><strong>Quickpin:</strong></div>
                    ...
                    <div className="row px-lg-0 px-sm-3 px-4">
                        <button className='mt-3 border border-dark text-dark rounded bg-light py-3'> Add new transaction</button>
                    </div>
                    <div className="row px-lg-0 px-sm-3 px-4 mb-lg-0 mb-3">
                        <button onClick={goHome} className="mt-3 border border-success rounded bg-gradients py-3"> Home</button>
                    </div>
                </div>
            </div>            
        </div>        
